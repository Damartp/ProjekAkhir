// ===========================
// KONFIGURASI URL CONTROLLER
// Sesuai struktur Laragon: http://localhost/ProjekAkhir/Ecommerce/...
// Kalau masih error, cek di browser: http://localhost/ProjekAkhir/Ecommerce/controllers/ProductController.php?action=getAll
// ===========================
const CTRL = '/ProjekAkhir/Ecommerce/controllers/ProductController.php';

// ===========================
// HELPER: Hapus cache produk di sessionStorage
...
async function loadProducts() {
  ...
  try {
    ...
    if (!data.success) {
      tbody.innerHTML = '<tr class="loading-row"><td colspan="9">Gagal memuat produk.</td></tr>';
      return;
    }
    ...
    tbody.innerHTML = '<tr class="loading-row"><td colspan="9">Error: Tidak dapat terhubung ke server.</td></tr>';
...
document.getElementById('btnCreate').addEventListener('click', async () => {
  ...
  try {
    ...
    if (data.success) {
      // ✅ FIX: Hapus cache agar home.php fetch ulang dari DB
      clearProductCache();
    ...
    showMsg(msg, 'Error: Tidak dapat terhubung ke server.', false);
